...
def autologin():
    ...
    time.sleep(2)
    # totp_text_field = driver.find_element("xpath",'/html/body/div[1]/div/div[2]/div[1]/div/div/div[2]/form/div[2]/div/input')
    # driver.find_element("xpath",'/html/body/div[1]/div/div[2]/div[1]/div/div/div[2]/form/div[2]/input')
    # totp_text_field = driver.find_element_by_xpath('/html/body/div[1]/div/div[2]/div[1]/div/div/div[2]/form/div[2]/div/input')
    # totp_text_field = driver.find_element("xpath",'/html/body/div[1]/div/div[2]/div[1]/div/div/div[2]/form/div[2]/input')
    totp_text_field = driver.find_element("xpath", '/html/body/div[1]/div/div/div[1]/div[2]/div/div/form/div[1]/input')
